...
def crisp_inicial(
    ...
    Example:
        ...
        >>> centro_Esq = crisp_inicial(imagem=imagem, lim_infY=180, lim_supY=360, lim_infX=0, lim_supX=255)
        array([172, 266])
        >>> centro_dir = crisp_inicial(imagem=imagem, lim_infY=180, lim_supY=360, lim_infX=256, lim_supX=512)
        array([335, 289])
    """
